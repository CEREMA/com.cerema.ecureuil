AO = {
	...
	getAll: function(o,cb) {
		AO.using('db').model('gestionao2','SELECT * FROM (appelsoffres LEFT JOIN domaine ON (domaine.id_domaine = appelsoffres.IdDomaine)) where YEAR(DateParution)>=2014 order by DateParution desc',cb);		
	},
