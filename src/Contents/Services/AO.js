AO = {
	...
	getAgents: function(o,cb) {
		AO.using('db').model('bpclight','select distinct * from agents left join mela on mela.Kage=agents.Kage where actif=1 and mela.libmela like "%cerema.fr" order by nom',cb);
	},
